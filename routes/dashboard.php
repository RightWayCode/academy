...
// services
get("/dashboard/{college_id}/{course_id}/services","dashboard/services/index");
get("/dashboard/{college_id}/{course_id}/service/add","dashboard/services/add");
get("/dashboard/service/edit","dashboard/services/edit");
get("/dashboard/service/view","dashboard/services/view");
// its post
post("/dashboard/{college_id}/{course_id}/service/add","dashboard/services/add");

// products
get("/dashboard/{college_id}/{course_id}/{service_id}/products","dashboard/products/index");
get("/dashboard/{college_id}/{course_id}/{service_id}/product/add","dashboard/products/add");
get("/dashboard/product/edit","dashboard/products/edit");
get("/dashboard/product/view","dashboard/products/view");
// its post
post("/dashboard/{college_id}/{course_id}/{service_id}/product/add","dashboard/products/add");
