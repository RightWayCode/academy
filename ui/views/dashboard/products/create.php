...
$service_name = "Notes & Study Material"; // dummy
?>
<div class="p-6 max-w-3xl mx-auto">
    ...
    <form action="#" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow space-y-4">
        ...
        <div>
            ...
            <input type="text" name="product_name" required class="w-full px-3 py-2 border rounded" placeholder="E.g. Semester 1 Notes">
        </div>
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <input type="text" name="semester" class="w-full px-3 py-2 border rounded" placeholder="1 or Sem-1 or N/A">
            </div>
        </div>
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input type="number" name="download_expiry_days" class="w-full px-3 py-2 border rounded" value="30" min="0">
            </div>
        </div>
